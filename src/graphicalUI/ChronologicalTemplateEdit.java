...
public class ChronologicalTemplateEdit {
	 ...
	 * @param functional2 
	 */
	public ChronologicalTemplateEdit(CommonAttributes functional,  ArrayList<CommonAttributes> arrayCv) {
	...
	private void initialize() {
		...
		JTextArea textArea = new JTextArea(functional.getParagraph("Core Strengths"));
		textArea.setBounds(36, 392, 216, 93);
		...
		JLabel lblSkillsAndExperience_1 = new JLabel("Core Strengths");
		...
		btnConfirm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				functional.addParagraph(professionalProfile.getText().toString(), "Core Strengths");
				frame.dispose();
